...
public final class NetworkCode {
  ...
  public static final int
      ...
      CHANGE_DEFAULT_REQUEST = 50,
      CHANGE_DEFAULT_RESPONSE=51,
          RETRIEVE_DEFAULT_REQUEST=52,
          RETRIEVE_DEFAULT_RESPONSE=53,
  		CHECK_MEMBER_REQUEST = 60,
  		CHECK_OWNER_REQUEST = 61,
  		CHECK_CREATOR_REQUEST = 62,
  		RETRIEVE_USER_STATUS = 63,
  		CHECK_REMOVED_REQUEST = 64,
	DELETE_CONVERSATION_REQUEST = 70,
		  DELETE_CONVERSATION_RESPONSE = 71,
      DELETE_USER_REQUEST = 72,
	  DELETE_USER_RESPONSE = 73;
}
