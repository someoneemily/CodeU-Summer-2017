...
public final class NetworkCode {
  ...
  public static final int
      ...
      INTEREST_CONVERSATION_REQUEST = 33,
      INTEREST_CONVERSATION_RESPONSE = 34,
      INTEREST_MESSAGE_REQUEST = 35,
      INTEREST_MESSAGE_RESPONSE = 36,
      NEW_USER_INTEREST_REQUEST = 37,
      REMOVE_USER_INTEREST_REQUEST = 38,
      NEW_CONVERSATION_INTEREST_REQUEST = 39,
      REMOVE_CONVERSATION_INTEREST_REQUEST = 40,
      GET_CHANGES_REQUEST = 41,
          GET_CHANGES_RESPONSE = 42;
}
