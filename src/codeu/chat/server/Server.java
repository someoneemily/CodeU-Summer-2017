...
public final class Server {
    ...
    public Server(final Uuid id, final Secret secret, final Relay relay, final String persistentFile) {
        ...
        //todo(all): Notice that right now, you're queueing first, and writing to server after. This should be the other way around.
        ...
        this.commands.put(NetworkCode.NEW_MESSAGE_REQUEST, new Command() {
            ...
            public void onMessage(InputStream in, OutputStream out) throws IOException {
                ...
                //create new message
                //todo(weizhen): This bit should be reconsidered to support messages with a space, see the bug
                if (message != null) {
                ...
                try {
                    ...
                    try{
                        ...
                        if (PersistentLog.persistentQueue.size() >= 5) {
                            ...
                            //todo(mattie): This can happen quite frequently in a chat app and might result in a time complexity problem.
    ...
    public void addNewMessage(String messageIdString, String userIdString, String convoIdString, String content, String timeString){
        ...
        Uuid userId;
        Uuid convoId;
//todo(weizhen): content with a space etc...
        try {
